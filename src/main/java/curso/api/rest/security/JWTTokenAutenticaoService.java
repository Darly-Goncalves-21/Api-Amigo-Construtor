...
@Service
@Component
public class JWTTokenAutenticaoService {
	...
	public void addAuthentication(HttpServletResponse response , String username) throws IOException {
		...
		//Liberando resposta para portas diferentes que usam a Api ou caso clients web
		...
		if (token != null) {
			...
			if (user != null) {
				...
				Usuario usuario = ApplicationContextLoad.getApplicationContext()
				        .getBean(UsuarioRepository.class).findUserByUserLogin(user);
